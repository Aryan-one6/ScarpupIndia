        ...
        >
          ...
          >
            <div className="grid grid-cols-4 gap-3 w-full relative">
              ...
              <div className="row-span-2 bg-[#fff] rounded-md h-40 2xl:max-w-[1280px] w-full flex flex-col items-center justify-center">
                <a
                  href="#"
                  className="group relative flex h-full w-9/12 items-end overflow-hidden rounded-lg bg-[white] h-[200px] md:col-span-2"
                >
                  <Image
                    src="/images/reliance-industries-logo.png"
                    alt="Photo by Magicle"
                    className="inset-0 h-full w-1/2 object-cover object-center transition duration-200 group-hover:scale-110"
              ...
              <div className="row-span-1 bg-[#fff] h-20 rounded-md flex flex-col items-center justify-center">
                <a
                  href="#"
              ...
              <div className="row-span-2 h-40 bg-[white] rounded-md flex flex-col items-center justify-center relative">
                <a
                  href="#"
                  className="group relative flex h-full w-full items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:col-span-2"
                >
              ...
              <div className="row-span-1 bg-[white] h-20 rounded-md flex flex-col items-center justify-center">
                <a
                  href="#"
                  className="group relative flex h-full w-full items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:col-span-2"
                >
